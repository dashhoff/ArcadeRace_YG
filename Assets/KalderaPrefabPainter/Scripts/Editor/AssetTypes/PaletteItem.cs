...
namespace CollisionBear.WorldEditor
{
    ...
    public class ScaleInformation
    {
        public enum AxisType : int
        {
            ...
            SeperateAxes = 1,
            RandomSingleAxis = 2,
            RandomSeperateAxis = 3
        }

        public AxisType Mode = AxisType.RandomSeperateAxis;
        ...
        public Vector3 Evaluate()
        {
            ...
            } else if (Mode == AxisType.RandomSeperateAxis) {
    ...
    public class PaletteItem
    {
        ...
        public Vector3 GetScale() => Scale.Evaluate();
        ...
        public bool HasNonCenteredPositionedVariants() => HasVariants() && GameObjectVariants.Any(g => g != null && g.transform.position != Vector3.zero);
        public bool HasNonCenteredRotationedVariants() => HasVariants() && GameObjectVariants.Any(g => g != null && g.transform.rotation != Quaternion.identity);
